...
import { Avatar, Link, InputAdornment, IconButton, FilledInput, InputLabel, FormControl  } from '@mui/material';
...
const UserTab = () => {
    ...
    return (
        <form>
            ...
            <br/>
            {/* should probably abstract these input items for less clutter */}
